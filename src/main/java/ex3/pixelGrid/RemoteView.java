...
public class RemoteView extends JFrame implements Remote, Serializable {
    ...
    public RemoteView(PixelGrid grid, BrushManager brushManager, int w, int h, BrushClient user){
        this.grid = grid;
        this.w = w;
        this.h = h;
